...
# Local alias used throughout UI (dropdowns/multiselects)
...
# Local alias used in playlist/cache blocks (prevents NameError)
cores_for_cache = list(st.session_state.cores_for_cache)
